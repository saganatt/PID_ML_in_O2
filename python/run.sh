...
OUT_DIR=/home/maja/CERN_part/CERN/PIDML/PID_ML_in_O2/python/data
...
for number in {001..010}; do
  o2-analysis-timestamp --isRun2MC -b | o2-analysis-centrality-table -b | o2-analysis-multiplicity-table -b | o2-analysis-trackextension -b | o2-analysis-trackselection -b | o2-analysis-pid-tof -b | o2-analysis-pid-tof-beta -b | o2-analysis-pid-tof-full -b | o2-analysis-pid-tpc-full -b |
